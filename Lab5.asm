...
comando: 	DB 		03h,28h, 0fh, 06h ; nro. de comandos - function set - display on/off - entry mode
	
WRT:		MOV 	A,#0 		; END. DO NRO DE COMANDOS/DADOS
			MOVC 	A,@A+DPTR
			MOV 	R6,A 		; R6=NRO DE COMANDOS/DADOS
			MOV 	R1,#1H 		; DESLOCAMENTO DO COMANDO/MENSAGEM INICIAL

LOOP:		MOV 	A,R1 		; END. DO PRIMEIRO DADO/COMANDO EM A
			MOVC 	A,@A+DPTR
